...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <div
      class="container d-flex flex-column gap-3 text-center justify-content-center"
    >
      <?php
    ...
    <div
      ...
      tabindex="-1"
      aria-labelledby="addsectionmodal"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="container modal-body">
            <form
              method="POST"
              action="../backend/addsection_backend.php"
    ...
    <div
      ...
      data-bs-keyboard="false"
      tabindex="-1"
      aria-labelledby="editsectionmodal"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="container modal-body">
            <form
              method="POST"
              action="../backend/editsection_backend.php"
              class="container d-flex flex-row gap-3"
            >
              <div class="form-floating">
                <input
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="container modal-body">
            ...
            <form
              method="POST"
              action="../backend/deletesection_backend.php"
              class="container d-flex flex-row gap-3"
            >
              <div class="form-floating">
                <input
    ...
    <div
      ...
      data-bs-keyboard="false"
      tabindex="-1"
      aria-labelledby="addprogrammodal"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="container modal-body">
            <form
              method="POST"
              action="../backend/addprogram_backend.php"
              class="container d-flex flex-row gap-3"
            >
             <div class="form-floating">
                <input
    ...
    <div
      ...
      data-bs-keyboard="false"
      tabindex="-1"
      aria-labelledby="editprogrammodal"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="container modal-body">
            <form
              method="POST"
              action="../backend/editprogram_backend.php"
              class="container d-flex flex-row gap-3"
            >
             <div class="form-floating">
                <input
                  type="text"
                  id="original_program_target"
                  name="original"
                  class="form-control"
                  readonly
                />
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="container modal-body">
            <form
              method="POST"
              action="../backend/deleteprogram_backend.php"
              class="container d-flex flex-row gap-3"
            >
             <div class="form-floating">
                <input
                  type="text"
                  id="delete_program_target"
                  name="program"
                  class="form-control"
                  readonly
                />
