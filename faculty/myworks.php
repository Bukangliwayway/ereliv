  ...
  function myworksEventsListener() {
    ...
    links.forEach(function (link) {
      ...
      link.addEventListener('click', function (event) {
        ...
        var researchIntroduction = this.querySelector('.research-introduction').getAttribute('data-full-text');
        var researchMethodology = this.querySelector('.research-methodology').getAttribute('data-full-text');
        var researchResults = this.querySelector('.research-results').getAttribute('data-full-text');
        var researchDiscussion = this.querySelector('.research-discussion').getAttribute('data-full-text');
        var researchConclusion = this.querySelector('.research-conclusion').getAttribute('data-full-text');
        var researchKeywords = this.querySelector('.research-keywords').getAttribute('data-full-text');
        var researchStatus = this.querySelector('.research-status').getAttribute('data-full-text');
        var researchClassification = this.querySelector('.research-classification').getAttribute('data-full-text');
        ...
        tinymce.get("abstract-input").setContent(researchAbstract);
        tinymce.get("introduction-input").setContent(researchIntroduction);
        tinymce.get("methodology-input").setContent(researchMethodology);
        tinymce.get("results-input").setContent(researchResults);
        tinymce.get("discussion-input").setContent(researchDiscussion);
        tinymce.get("conclusion-input").setContent(researchConclusion);
        ...
        // Function to set the selected option based on its value
        ...
        setSelectedOption(document.getElementById('research-status'), researchStatus);
        setSelectedOption(document.getElementById('research-classification'), researchClassification);
