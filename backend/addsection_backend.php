...
if (sectionDuplicateCheck($conn, $section))
  send_message_and_redirect($section . " was already in the Program", "http://localhost/ereliv/admin/");

if (addSection($conn, $section, $string))
  send_message_and_redirect($section . " was added successfully", "http://localhost/ereliv/admin/index.php?block=programListContainer");
