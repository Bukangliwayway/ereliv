...
//   // // Generate HTML for the research item
//   $output .= '<div href="#displaypapermodal" class="search-point search-research-link border border-smoke rounded my-1" data-bs-toggle="modal">';
//   $output .= '<div class="p-3 d-flex flex-column gap-2" style="position:relative;">';
