...
if (!empty($researches)) {
  ...
  foreach ($researches as $research) {
    ...
    $output .= '<input type="hidden" class="research-introduction" data-full-text="' . htmlspecialchars($research['introduction'], ENT_QUOTES) . '">';
    $output .= '<input type="hidden" class="research-methodology" data-full-text="' . htmlspecialchars($research['methodology'], ENT_QUOTES) . '">';
    $output .= '<input type="hidden" class="research-results" data-full-text="' . htmlspecialchars($research['results'], ENT_QUOTES) . '">';
    $output .= '<input type="hidden" class="research-discussion" data-full-text="' . htmlspecialchars($research['discussion'], ENT_QUOTES) . '">';
    $output .= '<input type="hidden" class="research-conclusion" data-full-text="' . htmlspecialchars($research['conclusion'], ENT_QUOTES) . '">';
    ...
    $output .= '<input type="hidden" class="research-status" data-full-text="' . $research['researchstatus'] . '">';
    $output .= '<input type="hidden" class="research-classification" data-full-text="' . $research['researchclassification'] . '">';
